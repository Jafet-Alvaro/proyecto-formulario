const submitFunction = (event) => {
    /* event.preventDefault() // que se prevenga la actualiación de la web
    const valido = validarFormulario() // Esto será true oi false según sea válido o no el formulario */
...
function validarFormulario(){
    ...
    camposTexto.forEach(campo => { 
        let errorCampo = document.getElementById('error' + campo.id.charAt(0).toUpperCase() + campo.id.slice(1)) // error + id con la primera letra en mayúscula
    ...
    // Validadción de nivel de estudio
